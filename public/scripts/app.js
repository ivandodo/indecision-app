...
var Student = function (_Person) {
    ...
    _createClass(Student, [{
        ...
        value: function getDescription() {
            ...
            this.hasMajor() ? description += ' Their major is ' + this.major + '.' : null;
...
var Traveller = function (_Person2) {
    ...
    _createClass(Traveller, [{
        ...
        value: function getGreeting() {
            ...
            location ? greeting += ' I\'m visiting from ' + this.location + '.' : null;
...
var me = new Student('Ivan', 31, 'Computer Science');
console.log(me.getDescription());

var other = new Student(undefined, 11);
console.log(other);

var traveller = new Traveller('Ana', 17, 'Moscow');
